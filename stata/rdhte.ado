	...
	************************************************
	...
	if "`is_factor'"=="true" {
		...
		forval i = 1/`I'  {
			...
			disp in smcl in gr "{ralign `ml':`lab'}" _col(`ml1b') " {c |} " _col(`ml2b') %5.3f scalar(tau_hat[`i',1]) _col(`ml3b')  " {c |} " %5.3f scalar(tau_t[`i',1]) _col(`ml4b')  %5.3f scalar(tau_pv[`i',1]) _col(`ml5b') %5.3f scalar(tau_ci_l[`i',1]) _col(`ml6b') %5.3f scalar(tau_ci_r[`i',1]) _col(`ml7b') %8.0f tau_N[`i',1] _col(`ml8b') %8.0f tau_N[`i',2] _col(`ml9b') %5.3f tau_h[`i',1] _col(`ml10b') %5.3f tau_h[`i',2]
		...
		forval i = 1/`I'  {
			...
			disp in smcl in gr "{ralign `ml':`lab'}" _col(`ml1b') " {c |} " _col(`ml2b') %5.3f scalar(tau_hat[`i',1]) _col(`ml3b')  " {c |} " %5.3f scalar(tau_t[`i',1]) _col(`ml4b')  %5.3f scalar(tau_pv[`i',1]) _col(`ml5b') %5.3f scalar(tau_ci_l[`i',1]) _col(`ml6b') %5.3f scalar(tau_ci_r[`i',1]) 
		}
